...
if getattr(sys, "frozen", False) and hasattr(sys, "_MEIPASS"):
    # PyInstaller extracts bundled templates/modules to _MEIPASS.
    BASE_DIR = Path(sys._MEIPASS)
    DATA_DIR = Path(tempfile.gettempdir()) / "antigravity_pcb_preview"
else:
    BASE_DIR = Path(__file__).resolve().parent.parent
    DATA_DIR = BASE_DIR

GERBER_DIR   = DATA_DIR / "gerbers"
...
def main():
    ...
    # Pass the app object directly so PyInstaller frozen builds work.
